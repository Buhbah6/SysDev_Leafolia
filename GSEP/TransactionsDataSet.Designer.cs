...
namespace GSEP {
    ...
    public partial class TransactionsDataSet : global::System.Data.DataSet {
        ...
        public partial class TransactionsDataTable : global::System.Data.TypedTableBase<TransactionsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public TransactionsRow AddTransactionsRow(string TransactionID, System.DateTime TransactionDate, decimal Total, string EmployeeID) {
        ...
        public partial class TransactionsRow : global::System.Data.DataRow {
            ...
            public string EmployeeID {
                get {
                    return ((string)(this[this.tableTransactions.EmployeeIDColumn]));
                }
                set {
...
namespace GSEP.TransactionsDataSetTableAdapters {
    ...
    public partial class TransactionsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Transactions] WHERE (([TransactionID] = @Original_TransactionI" +
                "D) AND ([TransactionDate] = @Original_TransactionDate) AND ([Total] = @Original_" +
                "Total) AND ([EmployeeID] = @Original_EmployeeID))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Transactions] ([TransactionID], [TransactionDate], [Total], [EmployeeID]) VALUES (@TransactionID, @TransactionDate, @Total, @EmployeeID);
SELECT TransactionID, TransactionDate, Total, EmployeeID FROM Transactions WHERE (TransactionID = @TransactionID)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Transactions] SET [TransactionID] = @TransactionID, [TransactionDate] = @TransactionDate, [Total] = @Total, [EmployeeID] = @EmployeeID WHERE (([TransactionID] = @Original_TransactionID) AND ([TransactionDate] = @Original_TransactionDate) AND ([Total] = @Original_Total) AND ([EmployeeID] = @Original_EmployeeID));
SELECT TransactionID, TransactionDate, Total, EmployeeID FROM Transactions WHERE (TransactionID = @TransactionID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT TransactionID, TransactionDate, Total, EmployeeID FROM dbo.Transactions";
        ...
        public virtual int Delete(string Original_TransactionID, System.DateTime Original_TransactionDate, decimal Original_Total, string Original_EmployeeID) {
        ...
        public virtual int Insert(string TransactionID, System.DateTime TransactionDate, decimal Total, string EmployeeID) {
        ...
        public virtual int Update(string TransactionID, System.DateTime TransactionDate, decimal Total, string EmployeeID, string Original_TransactionID, System.DateTime Original_TransactionDate, decimal Original_Total, string Original_EmployeeID) {
            if ((TransactionID == null)) {
                throw new global::System.ArgumentNullException("TransactionID");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(System.DateTime TransactionDate, decimal Total, string EmployeeID, string Original_TransactionID, System.DateTime Original_TransactionDate, decimal Original_Total, string Original_EmployeeID) {
            return this.Update(Original_TransactionID, TransactionDate, Total, EmployeeID, Original_TransactionID, Original_TransactionDate, Original_Total, Original_EmployeeID);
        }
    }
